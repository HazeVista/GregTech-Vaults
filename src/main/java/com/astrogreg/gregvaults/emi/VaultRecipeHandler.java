...
import com.astrogreg.gregvaults.screen.AbstractVaultMenu;
...
public class VaultRecipeHandler<T extends AbstractContainerMenu>
    ...
    public boolean craft(EmiRecipe recipe, EmiCraftContext<T> context) {
        ...
        com.astrogreg.gregvaults.network.VaultNetwork.CHANNEL.sendToServer(
                new com.astrogreg.gregvaults.network.CPacketFillCraftingGrid(recipe.getId(), template));
        return true;
    }
}
